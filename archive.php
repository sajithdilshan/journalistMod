...
<p class="comments">
<abbr class="updated" title="<?php the_time('Y-m-d\TH:i:s')?>"> Posted on <?php the_time('F jS, Y'); ?> <?php _e("at"); ?> <?php the_time('g:i a'); ?></abbr> with <a href="<?php comments_link(); ?>"><?php comments_number('zero comment','one comment','% comments'); ?></a>
</p>
